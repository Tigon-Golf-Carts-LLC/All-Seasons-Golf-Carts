        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors" data-testid="link-footer-financing">
                  Financing Options
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+14075551234" className="text-sm text-muted-foreground hover:text-foreground transition-colors" data-testid="link-phone">
                  (407) 555-1234
                </a>
              </li>
              <li className="flex items-center gap-3">
